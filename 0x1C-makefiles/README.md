...
Used for Makefile practice purposes throughout project. Provided by The Room
...
Provided by Alx software engineering School through the Room.
...
* **6. make -f 100-Makefile**
  * [100-Makefile](./100-Makefile): Makefile that creates an executable `schooln` based on
